      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url();?>mahasiswa/c_praktikum/buku_panduan">Buku Panduan Praktikum</a></li>
          </ul>
        </li>
        <!--<li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Praktikum<span class="caret"></span></a>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url();?>mahasiswa/c_penelitian/surat_izin_lembur">Surat Izin Lembur</a></li>
          </ul>
        </li>
        <li class="dropdown">
