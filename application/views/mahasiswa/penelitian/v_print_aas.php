...
$this->fpdf->Ln(1);
$this->fpdf->Cell(2, 0.5, 'Hal', 0, 'L');$this->fpdf->Cell(0.5, 0.5, ':', 0, 'C');$this->fpdf->MultiCell(10, 0.5, 'Permohonan Uji Sampel Dengan Alat Atomic Absorption Spectrophotometer (AAS)', 0, 'L');
$this->fpdf->Ln(1);
/*End of Header*/
...
$this->fpdf->MultiCell(15.5,0.5,'Dengan ini mengajukan permohonan kepada Ibu, kiranya berkenan memberi izin untuk pengujian sampel penelitian saya dengan menggunakan alat Atom Adsorpsion Spectrophotometer (AAS) di Laboratorium instrumentasi FMIPA UNJ. Kegiatan uji sampel tersebut dilaksanakan :',0,'J');
$this->fpdf->Ln(0.4);
$this->fpdf->Cell(1 , 0.5, ''); 
...
$this->fpdf->Ln();
$this->fpdf->Cell(1 , 0.5, '');
$this->fpdf->Cell(3.5 , 0.5, 'Uji Penentuan Logam');
$this->fpdf->Cell(0.5 , 0.5, ':');
$this->fpdf->Cell(10.5,0.5,$data_penelitian['uji_logam'],0,0,'L');
$this->fpdf->Ln(1);
...
/*End of Footer*/
$this->fpdf->Output('Form Penelitian AAS-'.$data_penelitian['noreg'].'.pdf', "I");
?>
