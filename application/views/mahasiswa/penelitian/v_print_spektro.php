...
$this->fpdf->MultiCell(10, 0.5, 'Permohonan Uji Sampel Dengan Alat Spektrofotometer UV-V15', 0, 'L');
$this->fpdf->Ln(1);
/*End of Header*/
...
$this->fpdf->MultiCell(15.5,0.5,'Dengan ini mengajukan permohonan kepada Ibu, kiranya berkenan memberi izin untuk pengujian sampel penelitian saya dengan menggunakan alat Spektrofotometer UV-V15 di Laboratorium instrumentasi FMIPA UNJ. Kegiatan uji sampel tersebut dilaksanakan :',0,'J');
$this->fpdf->Ln(0.4);
$this->fpdf->Cell(1 , 0.5, ''); 
...
/*End of Footer*/
$this->fpdf->Output('Form Penelitian Spektrofotometer-'.$data_penelitian['noreg'].'.pdf', "I");
?>
