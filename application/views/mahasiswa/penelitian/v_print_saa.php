...
$this->fpdf->MultiCell(10, 0.5, 'Permohonan Uji Sampel Dengan Alat SAA (Surface Area Analyzer)', 0, 'L');
$this->fpdf->Ln(1);
/*End of Header*/
...
/*End of Footer*/
$this->fpdf->Output('Form Penelitian SAA-'.$data_penelitian['noreg'].'.pdf', "I");
?>
