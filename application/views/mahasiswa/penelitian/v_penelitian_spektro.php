...
<h3>Penelitian Spektrofotometer UV-V15</h3>

<div class="container margs">
<form action="<?php echo base_url();?>mahasiswa/C_penelitian/do_penelitian_spektro" enctype="multipart/form-data" method="post" target="_blank">
