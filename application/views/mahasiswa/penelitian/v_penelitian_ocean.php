...
<h3>Penelitian Ocean Optics</h3>

<div class="container margs">
<form action="<?php echo base_url();?>mahasiswa/C_penelitian/do_penelitian_ocean" enctype="multipart/form-data" method="post" target="_blank">
