...
<h3>Penelitian Potentiostat</h3>

<div class="container margs">
<form action="<?php echo base_url();?>mahasiswa/C_penelitian/do_penelitian_poten" enctype="multipart/form-data" method="post" target="_blank">
