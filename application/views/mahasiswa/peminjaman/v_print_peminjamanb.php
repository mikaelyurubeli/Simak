...
$this->fpdf->Cell(6, $cell, 'Nama Bahan' , 0, 0, 'C');
$this->fpdf->Cell(5.5, $cell, 'Spesifikasi Bahan', 0, 0, 'C');
$this->fpdf->Cell(2, $cell, 'Jumlah', 0, 0, 'C');
$this->fpdf->Ln();

$i = 1;
foreach($data_bahan as $u){
$cell = 0.5;
$this->fpdf->SetFont('Times', '', 10);
...
$this->fpdf->SetFont('Times', '', 10);
$this->fpdf->Cell(1, $cell, $i, 0, 0, 'C');
$this->fpdf->Cell(6, $cell, $data_bahan['nama_bahan'], 0, 0, 'L');
$this->fpdf->Cell(5.5, $cell, $data_bahan['spesifikasi'], 0, 0, 'L');
$this->fpdf->Cell(2, $cell, $data_bahan['jumlah_peminjaman'], 0, 0, 'L');
$this->fpdf->Ln();
}*/
...
$this->fpdf->Cell(0.25, 0.5, '');
$this->fpdf->Cell(6, 0.5, $kalab['nama'], 0, 0, 'J');
$this->fpdf->Cell(6, 0.5, '', 0, 0, 'J');
...
$this->fpdf->SetFont('Times', '', 10);
$this->fpdf->Cell(0.25, 0.5, '');
$this->fpdf->Cell(6, 0.5, 'NIP. '.$kalab['nip'], 0, 0, 'J');
$this->fpdf->Cell(6, 0.5, '', 0, 0, 'J');
