...
/*Main*/
$this->fpdf->SetFont('Times', '', 10);
$this->fpdf->Cell(1, 0.5, 'No', 0, 0, 'C');
$this->fpdf->Cell(6, 0.5, 'Nama Alat', 0, 0, 'C');
$this->fpdf->Cell(5.5, 0.5, 'Spesifikasi Alat', 0, 0, 'C');
$this->fpdf->Cell(2, 0.5, 'Jumlah', 0, 0, 'C');
$this->fpdf->Ln();
...
$this->fpdf->Cell(6, $cell, $data_alat['nama_alat'], 0, 0, 'L');
$this->fpdf->Cell(5.5, $cell, $data_alat['spesifikasi'], 0, 0, 'L');
$this->fpdf->Cell(2, $cell, $data_alat['jumlah_peminjaman'], 0, 0, 'L');
$this->fpdf->Ln();
}
...
/*End of Footer*/
$this->fpdf->Output('Form Penelitian.pdf', "I");
?>
