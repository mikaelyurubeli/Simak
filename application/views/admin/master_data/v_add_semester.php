<div class="container">
  ...
  <div class="col-md-5" style="margin-top: 2%">
    ...
    <form action="<?php echo base_url();?>admin/c_master_data/do_add_semester" method="post">
      <table class="table table-borderless">
        <tr>
          <td width="140px">Semester</td>
          <td><input type="text" class="form-control" id="semester" name="semester" required></td>
        </tr>
