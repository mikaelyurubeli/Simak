<div class="container">
	<h3>Edit Data Alat Instrumen</h3>
	<?php foreach($bahan as $u){ ?>
	<div class="col-md-6" style="margin-top: 2%">
	<form action="<?php echo base_url()?>admin/c_peminjaman/update_alat_instrumen" method="post" enctype="multipart/form-data" runat="server">
		<table class="table table-borderless">
			...
			<tr>
				<td>Jumlah Alat</td>
				<td>
					<input type="text" name="jumlah" value="<?php echo $u->jumlah ?>" class="form-control" required>
                </td>
			</tr>
			<tr>
				<td>SOP/IK</td>
